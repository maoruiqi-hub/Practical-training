...
const routes = [
  ...
  { path: '/register', name: 'Register', component: () => import('../views/Register.vue') },
  {
    ...
    children: [
      ...
      { path: 'ability-map', name: 'AbilityMap', component: () => import('../views/AbilityMapView.vue') },
      { path: 'class-operations', name: 'ClassOperations', component: () => import('../views/ClassOperations.vue') },
